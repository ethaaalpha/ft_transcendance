...
CONFIG_USER_LENGTH_MAX = 12 #max 9 + 3 pour 42_
CONFIG_USER_LENGTH_MIN = 3

CONFIG_EMAIL_LENGTH_MAX = 254
CONFIG_EMAIL_LENGTH_MIN = 5

DEFAULT_PROFILE_PICTURE_NAME = ['mehdi.png', 'ethaniel.png', 'nico.png']

MESSAGE_LENGTH_MAX = 242
